...
#else
class SymbRegEvalOp : public Beagle::MPI::GP::EvaluationOp {

public:

  //! SymbRegEvalOp allocator type.
  typedef Beagle::AllocatorT<SymbRegEvalOp,Beagle::MPI::GP::EvaluationOp::Alloc> Alloc;
  //!< SymbRegEvalOp handle type.
  typedef Beagle::PointerT<SymbRegEvalOp,Beagle::MPI::GP::EvaluationOp::Handle> Handle;
  //!< SymbRegEvalOp bag type.
  typedef Beagle::ContainerT<SymbRegEvalOp,Beagle::MPI::GP::EvaluationOp::Bag> Bag;
#endif
